...
public class ClientDto implements Comparable<ClientDto> {
    ...
    public ClientDto(Long id, String firstName, String lastName, String address, String email, String phone, String fbLink,
                     LocalDateTime dateAdded, List<String> groups) {
        this.id = id;
